...
public class ResizingStatusEffect extends StatusEffect
{
	...
	public void onApplied(LivingEntity entity, AttributeContainer attributes, int amplifier)
	{
		...
		if (!entity.isSilent())
		{
			entity.world.playSound(null, pos.x, pos.y, pos.z, SoundEvents.ENTITY_EVOKER_CAST_SPELL, entity.getSoundCategory(), 1.0F, 1.0F);
		}
	}
	...
	public void onRemoved(LivingEntity entity, AttributeContainer attributes, int amplifier)
	{
		...
		if (!entity.isSilent())
		{
			entity.world.playSound(null, pos.x, pos.y, pos.z, SoundEvents.ENTITY_ZOMBIE_VILLAGER_CONVERTED, entity.getSoundCategory(), 1.0F, 1.0F);
		}
